    ...
    <>
      ...
      <div className="max-w-6xl mx-auto p-6 ms-64">
        <h1 className="text-3xl font-bold mb-4 mt-12">
          Find Help & Request Sessions
        </h1>
        <p className="text-gray-600 mb-8">
          Request help with specific topics and get matched with qualified
          peers.
        </p>
        ...
        <div className="flex border-b mb-8">
          {[
            ...
            { id: "active-tab", name: "My Sessions" },
          ].map((tab) => (
            <button
              key={tab.id}
        ...
        {/* Request Help Tab */}
        {activeTab === "request-tab" && <RequestHelpPage />}
