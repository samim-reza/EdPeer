    ...
    <main className="md:ml-64 pt-16 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading.summary ? (
          ...
          <div className="mb-8 p-6 bg-red-50 text-red-600 rounded-lg shadow-sm">
            <p>{error.summary}</p>
          </div>
        ) : (
                        ...
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              {activity.tutor_name} • {activity.student_name}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-gray-500 text-xs mt-1">{formatDate(activity.created_at)}</p>
                          </div>
                        </div>
                      </div>
                    ))}
